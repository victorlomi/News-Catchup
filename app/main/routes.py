...
def index():
    ...
    news_sources = {
        ...
        'bbcsports': source.Source('bbc-sport', 'BBC Sport', images['bbcsports']), 
        'billboard': source.Source("buzzfeed", "Buzzfeed", images['billboard']), 
        ...
        'cbc-news': source.Source("cbc-news", "CBC News", images['cbc-news']), 
